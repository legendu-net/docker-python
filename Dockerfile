...
RUN xinstall -y pyenv -ic \
    && pyenv install 3.7.9 \
    && ln -s /opt/pyenv/versions/3.7.9/bin/python /usr/bin/python3.7 \
    && /opt/pyenv/versions/3.7.9/bin/python -m pip install -U git+https://github.com/dclong/xinstall@main
